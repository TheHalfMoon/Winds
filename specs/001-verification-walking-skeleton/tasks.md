...
- [x] **T005** Reject dirty source checkout before provisioning.
- [x] **T006** Create a detached, locked Winds-owned candidate worktree outside the source checkout and record its ownership metadata without creating a verification branch.
- [x] **T007** Inspect candidate Git state using machine-readable output only; retain unknown/dirty state.
...
- [x] **T014** Revalidate candidate state and required checks before promotion, and persist the fresh promotion-recheck evidence.
