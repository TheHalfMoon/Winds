...
| SQLite / `rusqlite` | exact crate pin to be recorded with first implementation dependency lock | SQLite public domain / rusqlite MIT | Transactional local metadata/events/projections | Library dependency |
...
No copied donor code is currently authorized by this ledger unless a row includes exact copied/adapted paths and modification notes.
