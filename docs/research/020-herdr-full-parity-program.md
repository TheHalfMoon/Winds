...
**Status:** Research/governance preparation only. Non-authorizing until Spec 010 closes canonically and a separate successor entry gate lands.

**Prepared:** 2026-09-16

**Winds canonical base inspected:** `8d75cab455f11afddeaa6fbe6244dbb1021d1467`

**Herdr exact source pin:** `herdrdev/herdr@18061191fdc019498610aee81f0df93f6c2ebd31`

**Herdr tree:** `ab44d1c6939f1e9b5657512e831c6e50969941a2`
...
The current installable integration registry contains 17 targets:
...
This sequence is a research proposal until a post-T145 entry gate canonically accepts it. It intentionally decomposes the full parity goal so each high-authority boundary has its own threat model and evidence.
...
The prior roadmap used Herdr pin `ef2674bab8a3b38984578473c1a80589ebcbb333`. The 2026-09-16 audit uses `18061191fdc019498610aee81f0df93f6c2ebd31`, which is 181 commits later.

Those intervening commits materially touch remote transport, Windows behavior, session persistence, multi-machine navigation, integrations, plugins, agent/session handling, worktrees, client endpoints, and incremental rendering. Any formal Spec 011 entry must therefore use this audit or a newer exact pin, not the older September 1 feature snapshot as if it were current.

## 9. Current authority firewall

As of this document's base:

```text
SPEC_010_FIRST_DESKTOP_IMPLEMENTATION_PROGRAM=CLOSED_CANONICAL:NO
T143=CLOSED_CANONICAL:NO
T144=AUTHORIZED:NO
T145=CLOSED_CANONICAL:NO
...
The Founder direction does not mutate those facts. The next legal transition is to finish Spec 010. After T145 closes canonically, a separate entry-gate candidate may supersede the provisional post-Spec-010 research ordering and authorize **Spec 011 specification creation only**.
