...
#[cfg(any(target_os = "linux", target_os = "macos"))]
pub(crate) use posix_peer::{current_effective_uid, require_same_user_peer};
#[cfg(all(test, any(target_os = "linux", target_os = "macos")))]
pub(crate) use posix_peer::{peer_effective_uid, require_same_effective_user};

#[cfg(windows)]
#[path = "peer/windows.rs"]
mod windows_peer;

#[cfg(windows)]
pub(crate) use windows_peer::{
